namespace Server.Models
{
    ...
    public class V_RoleControllerAction : ISqlQueryProvider
    {
        ...
        {
            return
                @"select  r.Id RoleId, ra.Id RoleActionId, a.Id ActionId, c.Id ControllerId, r.Name RoleName, c.Name ControllerName, a.Name ActionName, ra.Enabled, c.Type
                , (case c.Type when 1 then 'Web Api' else 'Mvc' end) TypeName, r.IsAdmin
                from Role r
